	...
	return (
		<div className="flex-col items-stretch gap-12px">
			...
			<SettingItem label="头部高度">
				<InputNumber
					className="w-120px"
					defaultValue={header.height}
					onChange={(v) => themeStore.changeHeaderHeight(v)}
				/>
			</SettingItem>
			{/* 侧边栏配置 */}
			<SettingItem label="侧边栏宽度">
				<InputNumber className="w-120px" defaultValue={aside.width} onChange={(v) => themeStore.changeAsideWidth(v)} />
			</SettingItem>
			<SettingItem label="侧边栏折叠宽度">
				<InputNumber
					className="w-120px"
					defaultValue={aside.collapsedWidth}
