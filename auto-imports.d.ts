...
declare global {
  ...
  const buttonIcon: typeof import('./src/module/components/custom/button-icon')['default']
  ...
  const svgIcon: typeof import('./src/module/components/custom/svg-icon')['default']
